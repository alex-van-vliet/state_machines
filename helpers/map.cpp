...
using empty_map = helpers::map<helpers::list<>>;
using my_map = helpers::map<helpers::list<
...
static_assert(std::is_same_v<helpers::map_list_t<empty_map>, helpers::list<>>);
static_assert(std::is_same_v<helpers::map_list_t<my_map>, helpers::list<
                                                                  helpers::map_entry<int64_t, wrapper<64>>,
                                                                  helpers::map_entry<float, wrapper<32>>,
                                                                  helpers::map_entry<char, wrapper<8>>,
                                                                  helpers::map_entry<int32_t, wrapper<32>>>>);

static_assert(std::is_same_v<helpers::map_keys_t<empty_map>, helpers::list<>>);
static_assert(std::is_same_v<helpers::map_keys_t<my_map>, helpers::list<int64_t, float, char, int32_t>>);

static_assert(std::is_same_v<helpers::map_values_t<empty_map>, helpers::list<>>);
static_assert(std::is_same_v<helpers::map_values_t<my_map>, helpers::list<wrapper<64>, wrapper<32>, wrapper<8>, wrapper<32>>>);
...
static_assert(std::is_same_v<helpers::map_insert_t<empty_map, int64_t, wrapper<32>>, helpers::map<helpers::list<
                                                                                             helpers::map_entry<int64_t, wrapper<32>>>>>);
static_assert(std::is_same_v<helpers::map_insert_t<my_map, int64_t, wrapper<32>>, my_map>);
static_assert(std::is_same_v<helpers::map_insert_t<my_map, int16_t, wrapper<16>>, helpers::map<helpers::list<
                                                                                          helpers::map_entry<int64_t, wrapper<64>>,
                                                                                          helpers::map_entry<float, wrapper<32>>,
                                                                                          helpers::map_entry<char, wrapper<8>>,
                                                                                          helpers::map_entry<int32_t, wrapper<32>>,
...
static_assert(std::is_same_v<helpers::map_set_t<empty_map, int64_t, wrapper<32>>, helpers::map<helpers::list<
                                                                                          helpers::map_entry<int64_t, wrapper<32>>>>>);
static_assert(std::is_same_v<helpers::map_set_t<my_map, int64_t, wrapper<32>>, helpers::map<helpers::list<
                                                                                       helpers::map_entry<float, wrapper<32>>,
                                                                                       helpers::map_entry<char, wrapper<8>>,
                                                                                       helpers::map_entry<int32_t, wrapper<32>>,
                                                                                       helpers::map_entry<int64_t, wrapper<32>>>>>);
static_assert(std::is_same_v<helpers::map_set_t<my_map, int16_t, wrapper<16>>, helpers::map<helpers::list<
                                                                                       helpers::map_entry<int64_t, wrapper<64>>,
                                                                                       helpers::map_entry<float, wrapper<32>>,
                                                                                       helpers::map_entry<char, wrapper<8>>,
                                                                                       helpers::map_entry<int32_t, wrapper<32>>,
